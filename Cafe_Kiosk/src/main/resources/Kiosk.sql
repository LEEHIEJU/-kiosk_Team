...
INSERT INTO DRINKSIZE VALUES('A02', 'ICE', 0);
...
CREATE TABLE HOTICE(
FOODNUM VARCHAR2(45),
HOTICETYPE VARCHAR2(45),
HOTICEPLUSPRICE INT
);

SELECT * FROM HOTICE;

DELETE FROM HOTICE WHERE FOODNUM = 'B08';

INSERT INTO HOTICE VALUES('A01', 'HOT', 0);
INSERT INTO HOTICE VALUES('A02', 'HOT', 0);
INSERT INTO HOTICE VALUES('A02', 'ICE', 500);
INSERT INTO HOTICE VALUES('A03', 'HOT', 0);
INSERT INTO HOTICE VALUES('A03', 'ICE', 500);
INSERT INTO HOTICE VALUES('A04', 'HOT', 0);
INSERT INTO HOTICE VALUES('A04', 'ICE', 500);
INSERT INTO HOTICE VALUES('A05', 'HOT', 0);
INSERT INTO HOTICE VALUES('A05', 'ICE', 500);
INSERT INTO HOTICE VALUES('A06', 'HOT', 0);
INSERT INTO HOTICE VALUES('A06', 'ICE', 500);
INSERT INTO HOTICE VALUES('A07', 'HOT', 0);
INSERT INTO HOTICE VALUES('A07', 'ICE', 500);
INSERT INTO HOTICE VALUES('A08', 'HOT', 0);
INSERT INTO HOTICE VALUES('A08', 'ICE', 500);
INSERT INTO HOTICE VALUES('A09', 'HOT', 0);
INSERT INTO HOTICE VALUES('A09', 'ICE', 0);
INSERT INTO HOTICE VALUES('A10', 'HOT', 0);
INSERT INTO HOTICE VALUES('A10', 'ICE', 0);
INSERT INTO HOTICE VALUES('B01', 'ICE', 0);
INSERT INTO HOTICE VALUES('B02', 'ICE', 0);
INSERT INTO HOTICE VALUES('B03', 'ICE', 0);
INSERT INTO HOTICE VALUES('B04', 'ICE', 0);
INSERT INTO HOTICE VALUES('B05', 'ICE', 0);
INSERT INTO HOTICE VALUES('B06', 'ICE', 0);
INSERT INTO HOTICE VALUES('B07', 'ICE', 0);
INSERT INTO HOTICE VALUES('B08', 'ICE', 0);
INSERT INTO HOTICE VALUES('B09', 'ICE', 0);
INSERT INTO HOTICE VALUES('B10', 'ICE', 0);

ALTER TABLE HOTICE
ADD CONSTRAINT PK_FOODNUM2 PRIMARY KEY (FOODNUM,HOTICETYPE);

-- FK설정(HOTICE -> MENU)
ALTER TABLE HOTICE 
ADD CONSTRAINT FK_FOODNUM2 FOREIGN KEY(FOODNUM) REFERENCES MENU(FOODNUM);

-- 한가지 메뉴 조회
SELECT m.*, d.DRINKSIZETYPE FROM DRINKSIZE d, MENU m
WHERE M.FOODNUM = d.FOODNUM AND M.FOODNUM ='A02';

SELECT m.FOODNUM , m.FOODPRICE, d.DRINKSIZETYPE , d.PLUSPRICE , h.HOTICETYPE, h.HOTICEPLUSPRICE 
FROM MENU m , DRINKSIZE d , HOTICE h
WHERE M.FOODNUM = D.FOODNUM AND D.FOODNUM = H.FOODNUM
ORDER BY FOODNUM;
